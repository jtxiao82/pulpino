...
if {$rvcores ne ""} {
  ...
  add wave -group "Core Regfile"                                     $rvcores/clk_i $rvcores/riscv_tracer_i/cycles $rvcores/rst_ni $rvcores/regfile_we_wb $rvcores/regfile_waddr_fw_wb_o $rvcores/regfile_wdata
  ...
  add wave -group "IF/ID PIPE"                                       $rvcores/if_stage_i/instr_rdata_i
  add wave -group "IF/ID PIPE"                                       $rvcores/id_stage_i/instr_rdata_i
  ...
  #add wave -group "Trace"                                    $rvcores/riscv_tracer_i/*
}
